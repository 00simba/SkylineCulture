    ...
    <div className="max-w-7xl mx-auto px-4 py-12 overflow-hidden">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        ...
        <div className="space-y-6">
          ...
          {/* CONTACT FORM */}
          <div className="rounded-lg p-6 bg-zinc-100 shadow-md border border-zinc-300">
              ...
              <>
                ...
                <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <input
                    ...
                    className="w-full rounded p-3 bg-white border border-zinc-300"
                    value={fullName}
                  ...
                  <input
                    ...
                    name="email"
                    placeholder="Email"
                    className="w-full rounded-md p-3 bg-white border border-zinc-300"
                    value={email}
