...
const cars: Car[] = [
    {
        ...
        img: [
            ...
            `${cloudFrontUrl}/1/19.jpg`,
            `${cloudFrontUrl}/1/20.jpg`,
            

        ],
        price: "Sold",
        description: "An iconic JDM legend presented in the most sought-after color, this 1999 R34 GT-R V-Spec is a well-maintained and tastefully upgraded example. Finished in Bayside Blue (TV2) and showing 120,000 km, the car has been enhanced with quality, period-correct performance parts while retaining its original character.\n\nModifications & Upgrades:\n    •    NISMO oil cooler\n    •    NISMO muffler\n    •    NISMO reinforced timing belt\n    •    NISMO lightweight flywheel\n    •    NISMO front and rear suspension links\n    •    NISMO rear A-arms\n    •    ARC front-mount intercooler\n    •    Blitz coilovers\n\nThe car drives tight and responsive, with improved cooling, handling, and throttle response over stock. All upgrades are from respected Japanese brands, chosen for reliability and performance rather than excess.\n\nCondition & History:\n    •    120,000 km\n    •    Complete service records\n    •    Original books included\n    •    Well cared for and properly serviced\n\nThis is a rare opportunity to own a properly sorted R34 GT-R V-Spec with documented history and high-quality modifications. Ideal for an enthusiast, collector, or anyone looking for a true driver’s example of one of Nissan’s greatest performance cars.",
    },
    {
        id: '2',
        make: "Nissan Skyline",
